package main.java.il.co.ArrayListNew;

import main.java.il.co.ArrayListNewExceptions.IllegalIndexException;
import main.java.il.co.ArrayListNewExceptions.InitializationException;
...
class ArrayListNew<E> implements List<E> {
